...
red_list = [(0, 0, 153), (0, 0, 204), (0, 0, 255), (51, 51, 255), (102, 102, 255), (0, 0, 179), (45, 39, 104),
            (123, 135, 205)]
...
color_list = [red_list, orange_list, yellow_list, green_list, blue_list, indigo_list, violet_list, white_list,
              black_list, gray_list, beige_list, khaki_list, brown_list]
color_name_list = ['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet', 'white', 'black', 'gray', 'beige',
                   'khaki', 'brown']
            ...
            for line in lines:
                for index, color in enumerate(color_list):
                    ...
                    if number < train_num_per_color and flag == 'train':
                        cv2.imwrite(
                            "../dataset/color_classification/train/" + color_name_list[index % color_num] + "/" + str(
                                number) + ".jpg", gen_crop)
                    elif number < test_num_per_color and flag == 'test':
                        cv2.imwrite(
                            "../dataset/color_classification/test/" + color_name_list[index % color_num] + "/" + str(
                                number) + ".jpg", gen_crop)
