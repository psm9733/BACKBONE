...
def main():
    ...
    model = Scaled_Yolov4(task="tiny_imagenet", batch_size=batch_size, train_aug=train_transform, val_aug=valid_transform, workers=workers, learning_rate=learning_rate, weight_decay=weight_decay)
    # trainer.tune(model)
    trainer.fit(model)
