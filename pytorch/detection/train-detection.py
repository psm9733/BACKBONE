...
from model import Scaled_Yolov4
...
def main():
    ...
    model = Scaled_Yolov4(input_shape, classes=classes, batch_size=batch_size, train_aug=train_transform,
                          val_aug=valid_transform, workers=workers, learning_rate=learning_rate,
