...
class ResNet26(nn.Module):
    def __init__(self, activation, bias = True):
        ...
        self.output = ResidualBlock(in_channels=1024, activation=activation, out_channels=(256, 256, 1024), kernel_size=(3, 3), stride=1, padding=(1, 1))
...
class ResNet50(nn.Module):
    def __init__(self, activation, bias = True):
        ...
        self.output = ResidualBlock(in_channels=2048, activation=activation, out_channels=(512, 512, 2048), kernel_size=(3, 3), stride=1, padding=(1, 1))
...
class DenseNet32(nn.Module):
    def __init__(self, activation, bias=True):
        ...
        self.block1_end = DenseBlock(in_channels=128, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1))
        self.block2_end = DenseBlock(in_channels=224, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1))
        self.block3_end = DenseBlock(in_channels=352, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1))
        self.output = DenseBlock(in_channels=512, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1))
        self.densenet32 = nn.Sequential(
            ...
            DenseBlock(in_channels=192, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
            self.block2_end,
            ...
            DenseBlock(in_channels=384, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
            DenseBlock(in_channels=416, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
            DenseBlock(in_channels=448, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
...
class DenseNet64(nn.Module):
    def __init__(self, activation, bias=True):
        ...
        self.output = DenseBlock(in_channels=1024, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1))
        self.densenet64 = nn.Sequential(
            ...
            DenseBlock(in_channels=224, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
            DenseBlock(in_channels=256, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
            DenseBlock(in_channels=288, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
            DenseBlock(in_channels=320, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
            ...
            DenseBlock(in_channels=704, activation=activation, out_channels=(128, 32), kernel_size=(3, 3), stride=1, padding=(1, 1)),
