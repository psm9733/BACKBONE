...
from model.backbone import ResNet26, ResNet50, DenseNet64
...
class Classification(nn.Module):
    def __init__(self, activation, classes):
        ...
        self.backbone = DenseNet64(activation)
        self.classification_head = nn.Sequential(
            # Conv2D_BN(self.backbone.block4_end.Conv2D_BN_3.conv_layer.out_channels, activation, 1280, 1),     #resnetgi
